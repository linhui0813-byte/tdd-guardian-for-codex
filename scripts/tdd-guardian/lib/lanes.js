...
// everything that gates a commit plus everything that gates a push. `stop`
 ...
 * push subsumes commit; stop lanes are not implied by either.
 */
...
const IGNORED_PATH_RE = /(^|\/)\.codex\/tdd-guardian\//;
