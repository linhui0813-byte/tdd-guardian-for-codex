...
description: |
  ...
  assistant: "I'll apply the tdd-planner to decompose the currency refactor into discrete work items, identify risks, and define the test targets before any code is written."
  </example>
model: inherit
references:
