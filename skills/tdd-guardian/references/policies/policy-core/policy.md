...
The two axes are independent. A unit test can carry a Level 1 assertion; an e2e test can carry a Level 7 one. See the `references/policies/lane-policy/policy.md` skill for which behavior belongs at which level, and for how lanes bind to gate triggers.
...
| Question | Skill |
|----------|-------|
| Which tier does this behavior belong in? | `references/policies/lane-policy/policy.md` |
| What shape does the test matrix take? | `references/policies/test-matrix/policy.md` |
| How are thresholds computed and merged? | `references/policies/coverage-gate/policy.md` |
| What does the final review check? | `references/policies/review-gate/policy.md` |
| What command runs the tests in language X? | `references/policies/tooling-catalog/policy.md` |
